...
===================================================
```
> as-of **2026-07-25T06:48:13.903906+00:00** · provider `deterministic` · data **LIVE** · MIO valid True · news: 190 items, **20 full-text**, +132 from search
...
- **Engine bias (forward lean)**: mild downside (-2.38% expected)
...
- Strongest negative signal: **Geopolitics / oil shock** (model contribution -2.025)
- Dominant model driver: **Geopolitics** (47% of the modeled move)
- ⚠️ Primary macro risk: 40 headline(s) · SEVERE (closure/war/nuclear risk)
- 🎯 Notable decouplings: Lodha (Macrotech), Vedanta (own catalyst vs the **model's** market tilt — not vs the realised tape)

> **⚠️ Why the model could be wrong today**  
> - Largest uncertainty: geopolitics (40 headline(s) · SEVERE (closure/war/nuclear risk))  
...
| Geopolitics | 40 headline(s) | 🔴 Bearish bias | 92% | Days |
...
**India VIX** — importance 14% · level 14.03 (normal) ×1.0
  Transmission: India VIX → Risk-Off → High-beta / Leveraged Names
  Interactions: Oil × India-CPI

**Oil** — importance 9% · level $96.78 (crisis zone) ×1.8
...
**Other movers:**  
  Lodha (Macrotech) mild upside · LTIMindtree Balanced

**Decoupling** (own catalyst overriding the market):  
- **Lodha (Macrotech)** — tape down, stock up · _results/earnings catalyst_
...
|---|---|---:|
| immediate | mild downside | 1.12 pct_nifty |
| short | mild downside | 1.12 pct_nifty |
...
|---|---|---:|---|
| Geopolitical Risk | — | 0.471 | — |
| Oil | -3.9% | 0.4 | OVERRIDDEN |
| Freight / Tanker Insurance | — | 0.4 | OVERRIDDEN |
| Inflation | — | 0.34 | — |
| Import Landed Cost | — | 0.34 | — |
| RBI / Rates | — | 0.289 | — |
| Import-reliant Manufacturers | — | 0.289 | — |
| Banks & Consumer | — | 0.246 | OVERRIDDEN |
