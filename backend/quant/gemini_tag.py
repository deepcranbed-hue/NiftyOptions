...
Rules:
- sentiment is the effect on INDIAN equities. Use a fine-grained scale in 0.1 increments (e.g., -1.0, -0.9, ..., 0.0, ..., 0.9, 1.0) to represent the exact strength of the impact. Do not limit yourself to coarse -1, -0.5, 0, 0.5, 1 steps.
...
async def _tag_one(client: httpx.AsyncClient, article: dict, api_key: str) -> dict:
    ...
    constituents_data = [{"symbol": h.symbol, "sector": h.sector, "industry": h.industry, "weight": h.weight} for h in hits]
