...
SOURCES = {
    "BANKNIFTY": {"kind": "sqlite", "symbol": "BANKNIFTY",  "timeframe": "1d"},                     
    "USDINR":    {"kind": "sqlite", "symbol": "USDINR",   "timeframe": "1d", "transform": "pct"},
    "IN10Y_IDX": {"kind": "pg",     "factor": "IN10Y_INDEX","transform": "pct"},
    "US10Y":     {"kind": "pg",     "factor": "US10Y",    "transform": "diff"},
}
FACTORS = {k: v["transform"] for k, v in SOURCES.items() if k != TARGET}
US_FACTORS = [k for k, v in SOURCES.items() if v["kind"] == "pg" and k == "US10Y"]
...
def main():
    ...
    ap.add_argument("--us-lag", type=int, default=1)
