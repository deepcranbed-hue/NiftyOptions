#!/usr/bin/env python3
"""sync_it_bars_yf — daily bars for NIFTY IT constituents.
...
def main():
    ...
    print(f"database: {db}\nNIFTY IT constituents ({len(IT_STOCKS)}), {'FULL' if full else 'incremental'}:")
    res = sync_symbols(IT_STOCKS, db, full=full)
