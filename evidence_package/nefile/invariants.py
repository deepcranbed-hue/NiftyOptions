...
def evaluate(emission: dict,
    ...
    if rrf is None or rrx is None:
        ...
        # sign disagreement is a VALID market state rendered as MIXED_REGIME —
        # T-B fails only if the emission shows a numeric share despite disagreement.
        if agree:
            ...
            res.append(_failed("T-B", {"d_rr_fixed": b, "d_rr_floating": a,
                               ...
                               "sign mismatch must render MIXED_REGIME, not a numeric share"))
