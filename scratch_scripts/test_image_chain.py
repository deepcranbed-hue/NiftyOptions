...
S = 24100.0
T = 5.0 / 365.0 # Assuming 5 days to expiry for June 30th from June 25th
r = 0.0655

print("Testing with extract_rnd(..., put_prices=put_ltp)")
g, d = extract_rnd(strikes, call_ltp, S, T, r, put_prices=put_ltp)
st = rnd_stats(g, d, S)
print(st)

print("\nTesting WITHOUT put_prices (call_prices only)")
g2, d2 = extract_rnd(strikes, call_ltp, S, T, r)
