...
# Full indices dictionary mappings for Breeze based strictly on NSE Scrip Master
INDICES_MAP = {
    "NSEBANK": "CNXBAN",
    "CNXIT": "CNXIT",
    "CNXAUTO": "CNXAUTO",
    "FINNIFTY": "NIFTY_FIN_SERVICES",
    "INDIAVIX": "INDVIX",
...
# Days list starting from June 29th, 2026 to present (market days only)
DATES = [
...
def backfill_selected_indices():
    ...
    print(f"Starting selected Indices 1m bar backfill (June 29 to Present)")
