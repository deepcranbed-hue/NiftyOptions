...
print("Testing smooth=3")
g, d = extract_rnd(strikes, call_ltp, S, T, r, smooth=3, put_prices=put_ltp)
print(rnd_stats(g, d, S))

print("Testing smooth=5")
g, d = extract_rnd(strikes, call_ltp, S, T, r, smooth=5, put_prices=put_ltp)
print(rnd_stats(g, d, S))

print("Testing smooth=1")
g, d = extract_rnd(strikes, call_ltp, S, T, r, smooth=1, put_prices=put_ltp)
print(rnd_stats(g, d, S))
