...
sys.path.append(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "backend", "quant", "skew"))
...
import backend.tests.test_skew_invariants as ts
