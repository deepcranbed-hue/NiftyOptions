...
def fetch_upstox_candles(instrument_key="NSE_EQ|INE848E01016", interval="1minute", to_date="2023-11-13", from_date="2023-11-12", access_token=None):
    ...
    print(f"[Upstox] Requesting URL: {url}")
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"[Upstox] Successfully fetched {len(candles)} candles.")
            if candles:
...
if __name__ == "__main__":
    ...
    fetch_upstox_candles(access_token=token_arg)
